...
class ChatUtilsTest {
    ...
    fun testDeserializeInvalidDataThrowsException() {
        val emptyIdMessage =
            Message(id = "", senderId = "user1", content = "Hello", timestamp = 1616161616L)

        val emptyUserIdMessage =
            Message(id = "msg1", senderId = "", content = "Hello", timestamp = 1616161616L)

        val emptyContentMessage =
            Message(id = "msg1", senderId = "user1", content = "", timestamp = 1616161616L)

        val negativeTimestampMessage =
            Message(id = "msg1", senderId = "user1", content = "Hello", timestamp = -1616161616L)
