...
class FailingChatRepository : ChatRepository {
    ...
    override suspend fun getChatsOfCurrentUser(relatedPostType: PostType): List<Chat> = throw Exception("Network error")
    override suspend fun getPendingChatsOfCurrentUser(relatedPostType: PostType): List<Chat> = throw Exception("Network error")
