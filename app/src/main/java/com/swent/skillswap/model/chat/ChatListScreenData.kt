    ...
    fun getSamplePosts(): List<Post> {
        ...
        return listOf(
            ...
            Offer(
                ...
                ownerId = "user1",
                skills = setOf(SkillTag.LINEAR_ALGEBRA, SkillTag.CALCULUS),
                tags = emptySet(),
            ...
            Offer(
                ...
                ownerId = "user2",
                skills = setOf(SkillTag.COMPUTER_PROGRAMMING, SkillTag.DATA_STRUCTURES),
                tags = emptySet(),
            ...
            Offer(
                ...
                ownerId = "user3",
                skills = setOf(SkillTag.PHYSICS_MECHANICS, SkillTag.MATERIALS_ENGINEERING),
                tags = emptySet(),
                paymentMethod = PaymentMethod.SKILLS,
                expiry = future,
                creation = now,
            ...
            Request(
                ...
                ownerId = "user4",
                skills = setOf(SkillTag.CALCULUS, SkillTag.LINEAR_ALGEBRA),
                tags = emptySet(),
                paymentMethod = PaymentMethod.SKILLS,
                expiry = future,
                creation = now,
            ...
            Request(
                ...
                ownerId = "user1",
                skills = setOf(SkillTag.COMPUTER_PROGRAMMING, SkillTag.ALGORITHMS),
                tags = emptySet(),
                paymentMethod = PaymentMethod.SKILLS,
                expiry = future,
                creation = now,
