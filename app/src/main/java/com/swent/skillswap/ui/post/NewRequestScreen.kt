...
object NewRequestScreenTestTags {
...
fun NewRequestScreen(
    newRequestViewModel: NewRequestViewModel = viewModel(),
    onGoBack: () -> Unit = {},
    onPostCreated: () -> Unit = {},
) {
    val uiState by newRequestViewModel.uiState.collectAsState()
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Column(
                ...
                OutlinedTextField(
                    value = uiState.title,
                    onValueChange = { newRequestViewModel.setTitle(it) },
                    label = { Text("Title") },
                    ...
                    modifier = Modifier.fillMaxWidth().testTag(NewRequestScreenTestTags.TITLE_INPUT)
                )

                // Description Input
                OutlinedTextField(
                    value = uiState.description,
                    onValueChange = { newRequestViewModel.setDescription(it) },
