 ...
 * used chatGPT for comment and tagging the composable but they were checked
 */
...
/*TODO remove comment once viewModel made ->*/ /*viewModel: ViewModel = viewModel()*/
    goToMainScreen : () -> Unit = {},
    ...
    Scaffold() {
        ...
        Column(modifier = Modifier.padding(padding)
            .background(color = MaterialTheme.colorScheme.primary).fillMaxSize(1f)) {
            Spacer(modifier = Modifier.height(200.dp))
            Image(painter = painterResource(R.drawable.logo),
                contentDescription = "SkillSwap logo", Modifier.size(280.dp)
                    .align(Alignment.CenterHorizontally)
                    .testTag(SignInTags.LOGO)
                    )
            Spacer(modifier = Modifier.height(50.dp))
            OutlinedButton(onClick = {/*TODO CLICK LOGIC GOOGLE SIGN IN*/},
                colors = ButtonColors(Color.White, Color.Black,
            ...
            OutlinedButton(onClick = {/*TODO CLICK LOGIC SIGN IN*/},
                colors = ButtonColors(Color.White, Color.Black,
                    Color.White, Color.Black)
                , modifier = Modifier
                    .align(Alignment.CenterHorizontally)
            ...
            Text(text = "or", color = Color.White, modifier = Modifier
                .align(Alignment.CenterHorizontally)
                .testTag(SignInTags.OR_TEXT))
            Spacer(modifier = Modifier.height(10.dp))
            Text(text = "Create an account", /*TODO remove comment when color theme correct color = MaterialTheme.colorScheme.secondary,*/ modifier = Modifier
                .align(Alignment.CenterHorizontally)
