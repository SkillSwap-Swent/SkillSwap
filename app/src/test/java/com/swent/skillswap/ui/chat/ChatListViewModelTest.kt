    ...
    fun setup() {
        ...
        viewModel = ChatListViewModel(
            object : ChatRepository {
                ...
                override suspend fun getChatsOfCurrentUser(relatedPostType: PostType) = listOf(chat)
            },
            ...
            object : PostRepository {
                ...
                override suspend fun getMultiplePosts(numberOfPosts: Long, type: PostType, titleContains: String, ownerId: String,
                    paymentMethod: com.swent.skillswap.model.post.PaymentMethod?, tags: Set<com.swent.skillswap.model.tags.EveryTag>,
                    status: com.swent.skillswap.model.post.PostStatus?, userLocation: com.google.firebase.firestore.GeoPoint?, maxDistanceKm: Double?) = emptyList<Post>()
