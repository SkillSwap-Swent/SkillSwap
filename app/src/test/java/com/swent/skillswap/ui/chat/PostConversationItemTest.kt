...
class PostConversationItemTest {
    ...
    fun renders_username_title_and_tags() {
        ...
        composeRule.setContent { MaterialTheme { PostConversationItem(post = offer(), user = user, onClick = {}) } }
    ...
    fun shows_unknown_user_when_missing() {
        composeRule.setContent { MaterialTheme { PostConversationItem(post = offer(), user = null, onClick = {}) } }
    ...
    fun handles_no_tags_gracefully() {
        ...
        composeRule.setContent { MaterialTheme { PostConversationItem(post = noTagOffer, user = null, onClick = {}) } }
    ...
    fun renders_only_first_two_tags_when_more_present() {
        val manyTags = offer().copy(tags = listOf(
            SkillTag.COMPUTER_PROGRAMMING, SkillTag.DATA_STRUCTURES, SkillTag.ALGORITHMS
        ))
        composeRule.setContent { MaterialTheme { PostConversationItem(post = manyTags, user = null, onClick = {}) } }
        // First two visible
        composeRule.onNodeWithText("Computer programming", substring = true).assertExists()
    ...
    fun long_title_renders_without_crash() {
        ...
        composeRule.setContent { MaterialTheme { PostConversationItem(post = longTitle, user = null, onClick = {}) } }
